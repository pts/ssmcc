...
#ifdef __MINIX__
  /* The constants below are from Minix 2.0.4. */
...
#  define	ENAMETOOLONGG	36  /* file name too long */
...
#ifdef __ELKS__
  /* The constants brelow are from Dev86 0.16.21 and ELKS 0.8.1. */
#  define	EPERM		1	/* Operation not permitted */
#  define	ENOENT		2	/* No such file or directory */
#  define	ESRCH		3	/* No such process */
...
#  define	ELOOP		40	/* Too many symbolic links encountered */
  ...
  /* These are used in ELKS 0.8.1, pulled out of the unused list. */
...
#  ifdef _ERRNO_H_UNUSED  /* Not used in ELKS 0.8.1. */
#    define	EDEADLK		35	/* Resource deadlock would occur */
#    define	EWOULDBLOCK_OLD 41	/* Operation would block */
